...
class RecommenderSystem:
    ...
    def __init__(self, data_set, transaction_df, date, n_users=10, n_recommendations=10, top=3):
        ...
        self.test_users = [
            33237129, 33611229, 33236163, 33238638, 40620450, 33710592, 33240375, 37545453, 33259770, 40518873,
            33256614, 33256614, 33247263, 34655979, 33899601, 33640824, 33262227, 40161426,  33227430, 35226321,
            33254319, 33236958, 33253422, 38749023, 38232621]
